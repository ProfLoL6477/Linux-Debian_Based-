...
# Install Synaptic, VLC, Stacer, GParted, Htop, Ranger, Vim, Neovim, Neofetch, Timeshift, GUFW, PavuControl, and Ubuntu Restricted Extras
for package in synaptic gparted timeshift gufw pavucontrol vlc ubuntu-restricted-extras stacer htop ranger vim neovim neofetch; do
